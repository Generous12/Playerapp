          ...
          builder: (context, themeProvider, _) {
            ...
            return StatefulBuilder(
              builder: (context, setModalState) {
                ...
                final volPercent = (vol * 100).toInt();
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  CustomText(
                                    text: "Volumen de Salida de la App",
                                    fontSize: 16,
                                    fontWeight: FontWeight.bold,
                                    color: theme.colorScheme.onSurface,
                                  ),
                                  Text(
                                    "Ajusta el nivel de sonido de VibePlus",
                                    style: TextStyle(
                                      fontSize: 11.5,
                                      color: isDark
                                          ? Colors.white54
                          ...
                          const SizedBox(height: 12),
                          // Presets rápidos (0%, 25%, 50%, 75%, 100%)
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                            children: [0.0, 0.25, 0.50, 0.75, 1.0].map((
                              presetVal,
                            ) {
                              final presetPercent = (presetVal * 100).toInt();
                              final isCurrentPreset =
                                  (vol - presetVal).abs() < 0.05;

                              return InkWell(
                                borderRadius: BorderRadius.circular(10),
                                onTap: () {
                                  MusicService.instance.setVolume(presetVal);
                                  setModalState(() {});
                                },
                                child: Container(
                                  padding: const EdgeInsets.symmetric(
